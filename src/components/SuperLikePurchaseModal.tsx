...
import { Star, X, CreditCard, Play } from 'lucide-react-native';
      ...
      <View style={styles.overlay}>
        <View style={styles.content}>
          ...
          <Text style={styles.description}>
            Envoyez directement votre profil à <Text style={styles.highlight}>{userName || 'cet utilisateur'}</Text> sans attendre un match !
          </Text>

          <View style={styles.priceTag}>
            <Text style={styles.price}>{SUPER_LIKE_PRICE} F CFA</Text>
            <Text style={styles.unit}>par Super Like</Text>
          </View>
...
const styles = StyleSheet.create({
  ...
  iconWrap: { width: 80, height: 80, borderRadius: 40, backgroundColor: '#f59e0b', alignItems: 'center', justifyContent: 'center' },
  ...
  priceTag: { backgroundColor: '#fef3c7', paddingHorizontal: 20, paddingVertical: 10, borderRadius: 16, alignItems: 'center' },
