...
const StoriesPage: React.FC = () => {
  ...
  const labels = language === 'en'
    ? {
        ...
        lockedBody: 'Stories viewing is reserved for Premium members. Free accounts can unlock one post and up to 10 stories with a one-time 500 F payment.',
    ...
    : {
        ...
        lockedBody: 'La consultation des Stories est réservée aux membres Premium. Les comptes gratuits peuvent débloquer une publication et jusqu’à 10 stories avec un paiement ponctuel de 500 F.',
