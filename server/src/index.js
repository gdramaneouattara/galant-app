...
try { const securityRoutes = require('./routes/securityRoutes'); app.use('/api/security', securityRoutes); } catch (e) { mountErrors['/api/security'] = e.message; console.error('❌ Failed /api/security', e.message); }
